...
<body>
    ...
    <div class="popup">
        ...
        <div class="tabs">
            ...
            <div class="tabs_content">
                ...
                <ul class="icons">
                    <a href="#" class="facebook" data-href="https://developers.facebook.com/docs/plugins/"><i
            ...
            <div class="tabs_content">
                ...
                <iframe id="iframe" src="" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy"
    ...
    <script data-ad-client="ca-pub-6329141236261613" async
        src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
    <script
        src="https://developers.google.com/maps/documentation/javascript/examples/markerclusterer/markerclusterer.js">
    </script>
    <script src="http://google-maps-utility-library-v3.googlecode.com/svn/tags/markerclusterer/1.0/src/data.json">
    </script>
    <script src="https://maps.googleapis.com/maps/api/js?libraries=places"></script>
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyARIZbUxcAbaOrRWORojcB127pwxvRfZIQ&callback=initMap"
        type="text/javascript"></script>
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyARIZbUxcAbaOrRWORojcB127pwxvRfZIQ">
    </script>
